...
/**
 * Created by Sai on 18/10/2016.
 */

public class Patient_Attendance extends Activity {


    private TextView Total, PatientAttendance;


    public int TotalCount, NewCount, OldCount;
    ...
    private ProgressDialog pDialog_GetpatientAttendance;
    private int sai_Global;


    private static String url_PatientAnalytics;
    ...
    private String[] xValues = {"New count", "Old count", "Total"};


    private int[] yValues = {NewCount, OldCount};
    ...
    public static final int[] MY_COLORS = {
            Color.rgb(0, 128, 255), Color.rgb(0, 102, 204), Color.rgb(153, 204, 255),
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.patient_attendence);
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
                ...
                Toast.makeText(Patient_Attendance.this, xValues[e.getXIndex()] + " is " + e.getVal() + "", Toast.LENGTH_SHORT).show();
            }
    ...
    private void get_patientAttendence_Data() {
        ...
        if (isInternetOn() == true) {
            ...
            StringBuffer sb_patientAttendance = new StringBuffer();
            sb_patientAttendance.append(Constants.URL + "PatientAnalytics" + "?" + "DoctorId=" + mDoctor_id + "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&HospitalId=" + mHospital_id);
            url_PatientAnalytics = sb_patientAttendance.toString();
            System.out.println("GetPatientAnalytics_url---" + url_PatientAnalytics);
            new PatientAnalytics().execute(url_PatientAnalytics);
...
//				adding All to dropdown
    ...
    private void datepicker1() {
        ...
        final Dialog dialog = new Dialog(Patient_Attendance.this);
...
//            	 call webservice
    ...
    private void getIds() {
        ...
        PatientAttendance = (TextView) findViewById(R.id.patientAttendance);
        SpannableString content = new SpannableString("P a t i e n t  A t t e n d a n c e");
        content.setSpan(new UnderlineSpan(), 0, content.length(), 0);
        PatientAttendance.setText(content);
...
//	    			Toast.makeText(getApplicationContext(), "go back", Toast.LENGTH_SHORT).show();
        Intent i = new Intent(Patient_Attendance.this, DoctorsName_List.class);
        startActivity(i);
        finish();
        // return;
    }
    ...
    private class PatientAnalytics extends AsyncTask<String, Void, String> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog_GetpatientAttendance = new ProgressDialog(Patient_Attendance.this);
            pDialog_GetpatientAttendance.setMessage("Please Wait.");
            pDialog_GetpatientAttendance.setCancelable(false);
            pDialog_GetpatientAttendance.show();
        }
        ...
        protected void onPostExecute(String stream) {
                ...
                try {
                    ...
                    if (jArray.length() != 0) {
                        ...
                        for (int i = 0; i < jArray.length(); i++) {
                            ...
                            TotalCount = jObject1.getInt("TotalCount");
                            NewCount = jObject1.getInt("NewCount");
                            OldCount = jObject1.getInt("OldCount");

                            //yValues[0]=TotalCount;
                            yValues[0] = NewCount;
                            yValues[1] = OldCount;
                            ...
                            Appointments_Model appointments_model = new Appointments_Model(TotalCount, NewCount, OldCount);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                // display toast here
                                Toast.makeText(getApplicationContext(), "Patient Attendance collected", Toast.LENGTH_SHORT).show();
                            }
                        });
            ...
            if (pDialog_GetpatientAttendance.isShowing()) ;
            pDialog_GetpatientAttendance.dismiss();
            /**
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.doctorsname_list_menu2, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.power_doctorsname_list_menu:
                ...
                Intent i_home = new Intent(Patient_Attendance.this, RevenueByCategory.class);
