...
public class Doc_ConsultationType_Settings extends ArrayAdapter<Appointments_Model> {

    Context context;
    private LayoutInflater vi;
    public ArrayList<Appointments_Model> consultation_type_amt_list;

    public Doc_ConsultationType_Settings(Context context, int textViewResourceId, ArrayList<Appointments_Model> consultation_amt_list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = vi.inflate(R.layout.doc_consultation_amt_type_dialog_settings, null, true);
